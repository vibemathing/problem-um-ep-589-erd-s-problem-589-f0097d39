...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-589-erd-s-problem-589-f0097d39-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-589"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-589-erd-s-problem-589-f0097d39-v1",
      "problem_contract_sha256": "bb1cbb1d9d0a6fd07458a632893d8744fb1d942b39aa1e178999fc8b37be66d4",
      "problem_id": "problem:um-ep-589-erd-s-problem-589-f0097d39",
      "route_id": "route:um-ep-589-erd-s-problem-589-f0097d39-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-589-erd-s-problem-589-f0097d39-source-fidelity-01",
      "graph_id": "graph:um-ep-589-erd-s-problem-589-f0097d39-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-589-erd-s-problem-589-f0097d39-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-589-erd-s-problem-589-f0097d39-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $g(n)$ be maximal such that in any set of $n$ points in $\\mathbb{R}^2$ with no four points on a line there exists a subset on $g(n)$ points with no three points on a line. Estimate $g(n)$."
          },
          "statement_sha256": "dfd86322bcf2842882b50d1c4271bb766fdbf0f39bc5ef89356b62c26843bc9f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-589-erd-s-problem-589-f0097d39-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-589-erd-s-problem-589-f0097d39-root",
      "route_id": "route:um-ep-589-erd-s-problem-589-f0097d39-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-589-6e55f4bd5b07",
        "url": "https://www.unsolvedmath.com/problems/EP-589"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
